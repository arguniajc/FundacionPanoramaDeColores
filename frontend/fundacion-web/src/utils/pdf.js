...
// pestaña para impresión. Usa window.open para evitar depender de librerías
// de PDF del lado del cliente (jsPDF) para documentos simples.
export function abrirHojaDeVida(ins, edad) {
  ...
  if (!ventana) return; // popups bloqueados por el navegador
